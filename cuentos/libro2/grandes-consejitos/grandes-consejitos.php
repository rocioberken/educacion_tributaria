				...
				<ul class="bb-custom-grid" id="bb-custom-grid">
					<li>
						<div class="bb-bookblock">
							<div class="bb-item">
								<img src="cuentos/libro2/grandes-consejitos/images/1.jpg" alt="image01"/>
							</div>
						</div>
						<nav class="color21 blanco">
		...
		$( document ).ready(function() {
			$('#audio01').html('<audio id="player" preload><source src="cuentos/libro2/grandes-consejitos/audio/1.mp3" type="audio/mp3"</audio>');
				    $('#controles').show('slow');
			});
		</script>
		<script type="text/javascript">
