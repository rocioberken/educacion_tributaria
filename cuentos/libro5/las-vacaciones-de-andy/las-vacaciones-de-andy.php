				...
				<ul class="bb-custom-grid" id="bb-custom-grid">
					<li>
						<div class="bb-bookblock">
							<div class="bb-item">
								<img src="cuentos/libro5/las-vacaciones-de-andy/images/1.jpg" alt="image01"/>
							</div>
							<div class="bb-item">
								<img src="cuentos/libro5/las-vacaciones-de-andy/images/2.jpg" alt="image01"/>
							</div>
							<div class="bb-item">
								<img src="cuentos/libro5/las-vacaciones-de-andy/images/3.jpg" alt="image01"/>
							</div>
							<div class="bb-item">
								<img src="cuentos/libro5/las-vacaciones-de-andy/images/4.jpg" alt="image01"/>
							</div>
						</div>
						...
						<nav class="color23 blanco">
							...
							<!--
								...
								<button onclick="document.getElementById('player').volume += 0.1">Vol+ </button>-->
								<button onclick="window.open('audio-cuentos-5.html','_self');">Volver al indice</button>
							</div>
						</nav>
